...
::: {.card title="Medals by year" label="medals-by-year"}
...
## Column - Second Column {width=35%}

### Row - Valueboxes {height=35%}
...
### Row - Medals by country {height=75% .tabset}
```{python}
